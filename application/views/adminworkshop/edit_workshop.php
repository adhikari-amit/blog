...
<body>
   <?php include("adminworkshop_header.php"); ?>
    ...
    <div class="container my-5">
      <?php echo form_open_multipart('adminworkshop/update_workshop'); ?>
       <?php echo form_hidden('workshop_id',($workshop->workshop_id )); ?>
      ...
      <fieldset>
        ...
        <label  class="form-label mt-4">Workshop Name</label>
         <?php $data = array(
            ...
            'value'         => set_value('name',$workshop->workshop_name),
            );
        ...
        <label  class="form-label mt-4">Description</label>
         <?php $data = array(
            ...
            'value'         => set_value('desc',$workshop->workshop_description),
            );
        ...
        <label  class="form-label mt-4">Workshop Date</label>
         <?php $data = array(
            ...
            'type'          =>'date',
            'class'         =>'form-control',
            'value'         => set_value('workshop_date',$workshop->workshop_date),
            );
        ...
        <label  class="form-label mt-4">Workshop Time</label>
         <?php $data = array(
            ...
            'type'          =>'time',
            'class'         =>'form-control',
            'value'         => set_value('workshop_time',$workshop->workshop_time),
            );
        ...
        <label  class="form-label mt-4">Venue</label>
         <?php $data = array(
            ...
            'class'         =>'form-control',
            'placeholder'   =>"Description",
            'value'         => set_value('venue',$workshop->workshop_venue),
            );
        ...
        $options['upcoming']='upcoming';
          $data = array(
            ...
            'class'         =>'form-select',
            'options'       => $options,
            'value'         => set_value('status',$workshop->status),
          );
        ...
        <?php 
         $data = array(
            ...
            'id'            => 'price',
            'class'         =>'form-control',
            'value'         => set_value('price',$workshop->price),
            );
