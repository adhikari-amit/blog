      ...
      <table class="table table-hover">
        ...
        <?php   if(count($workshops)): ?>
         ...
         <?php  foreach($workshops as $workshop): ?>
            ...
            <td><?= $workshop->workshop_date;?>, <?= $workshop->workshop_time;?></td>
            <td><?= $workshop->workshop_venue; ?></td>
           
            <td> 
              <?= anchor("adminworkshop/write_invitation/{$workshop->workshop_id}","Send Invitation",['class'=>'btn btn-outline-warning btn-sm']) ?>
            </td>
          </tr> 
        <?php  endforeach; ?>
      <?php else: ?>
