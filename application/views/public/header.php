 ...
 <header>
   <div class="site-brand text-center">
     <div class="container">
       <a href="/">
         <div class="header-with-logo" style="display:flex; flex-wrap: nowrap; align-items: baseline;">
           <h2 class="site-logo-name" style="font-family: Samarkan;">Kahaniyaa..</h2><img class="img-responsive-header" src="<?= base_url('assets/images/logo.png'); ?>">
         </div>
       </a>
       </a>
     </div>
